...
RSpec.describe "originubs/new", type: :view do
  before(:each) do
    assign(:originub, Originub.new(
      :latitude => 1.5,
      :longitude => 1.5,
      :cod_munic => 1,
      :cod_cnes => 1,
  ...
  it "renders new originub form" do
    render

    assert_select "form[action=?][method=?]", originubs_path, "post" do
